...
class FrontController extends Controller
{
	...
	public function product()
	{
	    ...
	    // $categories = Category::with(['child'])->withCount(['child'])->getParent()->orderBy('name', 'ASC')->get(); //-> dipindah ke View Composer
	...
	public function verifyCustomerRegistration($token) //chap 10
	{
	...
	public function customerSettingForm() //chap 12
	{
