            ...
            <h3>Informasi Pengiriman</h3>          
              ...
              <form class="row contact_form" action="{{ route('front.store_checkout') }}" method="post" novalidate="novalidate">
                        ...
                        <div class="col-md-6 form-group p_star">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="{{ !null == auth()->guard('customer')->check()  ? auth()->guard('customer')->user()->email : ""}}" required {{ auth()->guard('customer')->check() ? 'readonly':'' }}>
